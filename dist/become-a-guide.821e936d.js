function u(u){return u&&u.__esModule?u.default:u}var e={};e=new URL("flag-ua.206ac488.svg",import.meta.url).toString();var t={};t=new URL("flag-ru.88f26cb7.svg",import.meta.url).toString();var s={};s=new URL("flag-germany.831dd278.svg",import.meta.url).toString();var l={};l=new URL("flag-eng.a2a964e4.svg",import.meta.url).toString();var a={};a=new URL("telegram.24c4005e.svg",import.meta.url).toString();var i={};i=new URL("viber.f82a6078.svg",import.meta.url).toString();var n={};n=new URL("menu_burger.81edf69f.svg",import.meta.url).toString();var c={};c=new URL("logo.8de3bcdb.png",import.meta.url).toString();var r={};r=new URL("add_object_icon.82b1f3ce.svg",import.meta.url).toString();var d={};d=new URL("become_a_guide_icon.69829ad1.svg",import.meta.url).toString();var o={};o=new URL("phone-header-icon.cf788f78.svg",import.meta.url).toString();var m={};m=new URL("search_icon.aeb707ee.svg",import.meta.url).toString(),new URL("donate_button.7f042bee.svg",import.meta.url).toString();var p={};p=new URL("phone-orange.e3912029.svg",import.meta.url).toString();var g={};g=new URL("telegram-orange.6f2c5380.svg",import.meta.url).toString();var v={};v=new URL("viber-orange.efa35444.svg",import.meta.url).toString();class x extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    ...
    `;let m=document.getElementById("btn_menu"),x=document.querySelector(".menu"),b=document.getElementById("menu-items"),f=this.querySelectorAll("#menu-items li"),E=this.querySelectorAll(".sub-menu"),h=document.getElementById("add-btn"),y=document.getElementById("add-section"),w=document.getElementById("contact-btn"),A=document.getElementById("contact-section"),C=document.getElementById("leng"),B=document.getElementById("leng-menu"),L=document.getElementById("currency"),F=document.getElementById("currency-menu"),D=document.getElementById("currency-data"),S=document.querySelectorAll(".close-menu"),k=document.querySelectorAll(".go-back"),q=document.querySelector(".hide"),_=document.getElementById("sidebar-leng"),H=document.getElementById("sidebar-leng-menu");function $(){return window.innerWidth>=1440}_.addEventListener("click",()=>{H.classList.toggle("!hidden")}),document.querySelectorAll("#sidebar-leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;_.innerHTML=e,H.classList.add("!hidden")})}),document.addEventListener("click",u=>{_.contains(u.target)||H.contains(u.target)||H.classList.add("!hidden")}),S.forEach(u=>{u.addEventListener("click",()=>{x.classList.add("hidden"),b.classList.remove("hidden")})}),m.addEventListener("click",function(){x.classList.toggle("hidden"),E.forEach(u=>{u.classList.add("hidden")}),x.classList.contains("hidden")&&b.classList.remove("hidden")}),document.addEventListener("click",u=>{u.target===m||m.contains(u.target)||x.contains(u.target)||x.classList.contains("hidden")||(x.classList.add("hidden"),b.classList.remove("hidden"))}),f.forEach(u=>{u.addEventListener("click",()=>{let e=u.id;E.forEach(u=>{u.classList.add("hidden")});let t=this.querySelector(`#${e}-list`);t&&($()?t.classList.remove("hidden"):(t.classList.remove("hidden"),b.classList.add("hidden")))})}),k.forEach(u=>{u.addEventListener("click",()=>{let e=u.closest(".sub-menu");e&&(e.classList.add("hidden"),b.classList.remove("hidden"))})}),document.getElementById("popular-dest").addEventListener("click",()=>{let u=document.getElementById("popular-dest-list");u&&($()?u.classList.remove("hidden"):(u.classList.remove("hidden"),b.classList.add("hidden")))}),q.addEventListener("click",()=>{document.getElementById("popular-dest-list").classList.add("hidden")}),h.addEventListener("click",()=>{y.classList.toggle("!hidden")}),document.addEventListener("click",u=>{h.contains(u.target)||y.contains(u.target)||y.classList.add("!hidden")}),w.addEventListener("click",()=>{A.classList.toggle("!hidden")}),document.addEventListener("click",u=>{w.contains(u.target)||A.contains(u.target)||A.classList.add("!hidden")}),L.addEventListener("click",()=>{F.classList.toggle("!hidden")}),C.addEventListener("click",()=>{B.classList.toggle("!hidden")}),document.querySelectorAll("#leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;C.innerHTML=e,B.classList.add("!hidden")})}),document.addEventListener("click",u=>{C.contains(u.target)||B.contains(u.target)||B.classList.add("!hidden")}),document.querySelectorAll("#currency-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".currency-select").textContent;D.textContent=e,F.classList.add("!hidden")})}),document.addEventListener("click",u=>{L.contains(u.target)||F.contains(u.target)||F.classList.add("!hidden")}),Array.from(document.getElementsByClassName("open-add-object")).forEach(u=>{u.addEventListener("click",()=>{document.getElementById("add-object-overlay").classList.remove("hidden")})})}}customElements.define("header-component",x);var b={};b=new URL("Facebook.dcf2fbbe.svg",import.meta.url).toString();var f={};f=new URL("Instagram.74df3eed.svg",import.meta.url).toString();var E={};E=new URL("Pinterest.66237f30.svg",import.meta.url).toString();var h={};h=new URL("Telegram.c0d61c3a.svg",import.meta.url).toString();var y={};y=new URL("Youtube.0f227ef9.svg",import.meta.url).toString();class w extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    <footer class="bg-white">
        ...
        <div class="main-footer side-paddings ">
            ...
            <div class="footer-icons">
                ...
                <a href="#">
                    <img src="${u(f)}" alt="Instagram">
                </a>
                <a href="#">
                    <img src="${u(E)}" alt="Pinterest">
                </a>
                <a href="#">
    ...
    `;let a=document.getElementById("foo-leng"),i=document.getElementById("foo-leng-menu"),n=document.getElementById("foo-currency"),c=document.getElementById("foo-currency-menu"),r=document.getElementById("foo-currency-data");n.addEventListener("click",()=>{c.classList.toggle("!hidden")}),a.addEventListener("click",()=>{i.classList.toggle("!hidden")}),document.querySelectorAll("#foo-leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;a.innerHTML=e,i.classList.add("!hidden")})}),document.addEventListener("click",u=>{a.contains(u.target)||i.contains(u.target)||i.classList.add("!hidden")}),document.querySelectorAll("#foo-currency-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".currency-select").textContent;r.textContent=e,c.classList.add("!hidden")})}),document.addEventListener("click",u=>{n.contains(u.target)||c.contains(u.target)||c.classList.add("!hidden")})}}customElements.define("footer-component",w);var A={};A=new URL("arrow-down.d7848c8b.svg",import.meta.url).toString();var C={};C=new URL("sunset.822f0583.png",import.meta.url).toString(),document.addEventListener("DOMContentLoaded",function(){let u=document.querySelectorAll(".accordion");if("/hotel.html"===window.location.pathname){let u=document.querySelector(".faq-img");u&&(u.style.display="none")}u.forEach((e,t)=>{if(e.addEventListener("click",function(){var e;this.classList.toggle("active");let t=this.nextElementSibling;t.classList.contains("active")?(t.classList.remove("active"),t.style.maxHeight=null,t.previousElementSibling.querySelector(".orange-border").classList.add("hidden")):(t.classList.add("active"),t.style.maxHeight=t.scrollHeight+"px",t.previousElementSibling.querySelector(".orange-border").classList.remove("hidden")),e=this,u.forEach(u=>{let t=u.nextElementSibling;u!==e&&(t.classList.remove("active"),t.style.maxHeight=null,u.querySelector("img").style.transform="rotate(0deg)",t.previousElementSibling.querySelector(".orange-border").classList.add("hidden"))});let s=t.classList.contains("active")?"180deg":"0deg";this.querySelector("img").style.transform=`rotate(${s})`}),1===t){e.classList.add("active");let u=e.nextElementSibling;u.classList.add("active"),u.style.maxHeight=u.scrollHeight+"px",e.querySelector("img").style.transform="rotate(180deg)",u.previousElementSibling.querySelector(".orange-border").classList.remove("hidden")}})});class B extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
        <h2 class="main-title">\u{41F}\u{43E}\u{448}\u{438}\u{440}\u{435}\u{43D}\u{456} \u{437}\u{430}\u{43F}\u{438}\u{442}\u{430}\u{43D}\u{43D}\u{44F}</h2>
            <div class="faq">
                ...
                <img src="${u(C)}" alt="img" class="faq-img">
            </div>
    `,this.addStructuredData()}addStructuredData(){let u=Array.from(this.querySelectorAll(".accordion")).map((u,e)=>({"@type":"Question",name:u.querySelector(".question").innerText.trim(),acceptedAnswer:{"@type":"Answer",text:u.nextElementSibling.querySelector(".panel p").innerText.trim()}})),e=document.createElement("script");e.type="application/ld+json",e.innerHTML=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:u}),this.appendChild(e)}}customElements.define("faq-component",B);var L={};L=new URL("x.b6b5ca8f.svg",import.meta.url).toString();var F={};F=new URL("tabler-icon-circle-check.24895de6.jpg",import.meta.url).toString();var D={};D=new URL("ava.060342ab.jpg",import.meta.url).toString();var S={};S=new URL("icon-phone.bd17d90e.svg",import.meta.url).toString();class k extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
        <div class="sidebar">
                ...
                <form id="booking-form" class="form-hotel" action="#">
                    ...
                    <div id="success-popup">
                        <div class="flex justify-end absolute top-4 right-4 hidden">
                            <img src=${u(L)} alt="close">
                        </div>
                        <img src=${u(F)} alt="img" class="mx-auto w-20 h-20 mb-5">
