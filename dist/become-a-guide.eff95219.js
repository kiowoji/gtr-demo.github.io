function u(u){return u&&u.__esModule?u.default:u}var e={};e=new URL("flag-ua.206ac488.svg",import.meta.url).toString();var t={};t=new URL("flag-ru.88f26cb7.svg",import.meta.url).toString();var l={};l=new URL("flag-germany.831dd278.svg",import.meta.url).toString();var s={};s=new URL("telegram.24c4005e.svg",import.meta.url).toString();var a={};a=new URL("viber.f82a6078.svg",import.meta.url).toString();var i={};i=new URL("menu_burger.81edf69f.svg",import.meta.url).toString();var n={};n=new URL("logo.8de3bcdb.png",import.meta.url).toString();var c={};c=new URL("add_object_icon.82b1f3ce.svg",import.meta.url).toString();var d={};d=new URL("become_a_guide_icon.69829ad1.svg",import.meta.url).toString();var r={};r=new URL("phone-header-icon.cf788f78.svg",import.meta.url).toString();var o={};o=new URL("search_icon.aeb707ee.svg",import.meta.url).toString(),new URL("donate_button.7f042bee.svg",import.meta.url).toString();var m={};m=new URL("phone-orange.e3912029.svg",import.meta.url).toString();var p={};p=new URL("telegram-orange.6f2c5380.svg",import.meta.url).toString();var v={};v=new URL("viber-orange.efa35444.svg",import.meta.url).toString();class g extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
        <header id="header">
        <div class="bg-header-top">
            <div class="flex-alignment">
                <div class="flex-alignment py-3">
                    ...
                    <a class=" text-gray-400 text-base mr-5" href="#">\u{411}\u{43B}\u{43E}\u{433}</a>
                    <a class=" text-gray-400 text-base "  href="#">\u{41F}\u{440}\u{43E} \u{43D}\u{430}\u{441}</a> 
                </div>
                <div class="flex-alignment">
                    <a href="#">
            ...
            <div class="sm:block md:block lg:flex justify-between items-center">
                <div class="flex-alignment w-full sm:flex-wrap md:flex-nowrap lg:flex-nowrap">
                    <div class="flex items-center w-max">
                        <button id="btn_menu">
                        <img src="${u(i)}" alt="menu" class="w-10 h-10 lg:w-[60px] lg:h-[60px] max-w-fit">
                        </button>
                        <a class="ml-4 mr-2 flex" href="/">
                        <img src="${u(n)}" alt="logo" class="logo">
                        </a>
                    </div>
                    ...
                    <div class="sm:flex md:flex lg:hidden gap-4 md:order-last">
                        <button id="add-btn">
                            <img src="${u(c)}" alt="icon" class="w-[40px] md:max-w-fit">
                        </button>
    ...
    `;let o=document.getElementById("btn_menu"),g=document.querySelector(".menu"),x=document.getElementById("menu-items"),f=this.querySelectorAll("#menu-items li"),b=this.querySelectorAll(".sub-menu"),E=document.getElementById("add-btn"),h=document.getElementById("add-section"),y=document.getElementById("contact-btn"),w=document.getElementById("contact-section"),A=document.getElementById("leng"),C=document.getElementById("leng-menu"),B=document.getElementById("currency"),F=document.getElementById("currency-menu"),L=document.getElementById("currency-data"),D=document.querySelectorAll(".close-menu"),S=document.querySelectorAll(".go-back"),k=document.querySelector(".hide"),q=document.getElementById("sidebar-leng"),_=document.getElementById("sidebar-leng-menu");function H(){return window.innerWidth>=1440}q.addEventListener("click",()=>{_.classList.toggle("!hidden")}),document.querySelectorAll("#sidebar-leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;q.innerHTML=e,_.classList.add("!hidden")})}),document.addEventListener("click",u=>{q.contains(u.target)||_.contains(u.target)||_.classList.add("!hidden")}),D.forEach(u=>{u.addEventListener("click",()=>{g.classList.add("hidden"),x.classList.remove("hidden")})}),o.addEventListener("click",function(){g.classList.toggle("hidden"),b.forEach(u=>{u.classList.add("hidden")}),g.classList.contains("hidden")&&x.classList.remove("hidden")}),document.addEventListener("click",u=>{u.target===o||o.contains(u.target)||g.contains(u.target)||g.classList.contains("hidden")||(g.classList.add("hidden"),x.classList.remove("hidden"))}),f.forEach(u=>{u.addEventListener("click",()=>{let e=u.id;b.forEach(u=>{u.classList.add("hidden")});let t=this.querySelector(`#${e}-list`);t&&(H()?t.classList.remove("hidden"):(t.classList.remove("hidden"),x.classList.add("hidden")))})}),S.forEach(u=>{u.addEventListener("click",()=>{let e=u.closest(".sub-menu");e&&(e.classList.add("hidden"),x.classList.remove("hidden"))})}),document.getElementById("popular-dest").addEventListener("click",()=>{let u=document.getElementById("popular-dest-list");u&&(H()?u.classList.remove("hidden"):(u.classList.remove("hidden"),x.classList.add("hidden")))}),k.addEventListener("click",()=>{document.getElementById("popular-dest-list").classList.add("hidden")}),E.addEventListener("click",()=>{h.classList.toggle("!hidden")}),document.addEventListener("click",u=>{E.contains(u.target)||h.contains(u.target)||h.classList.add("!hidden")}),y.addEventListener("click",()=>{w.classList.toggle("!hidden")}),document.addEventListener("click",u=>{y.contains(u.target)||w.contains(u.target)||w.classList.add("!hidden")}),B.addEventListener("click",()=>{F.classList.toggle("!hidden")}),A.addEventListener("click",()=>{C.classList.toggle("!hidden")}),document.querySelectorAll("#leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;A.innerHTML=e,C.classList.add("!hidden")})}),document.addEventListener("click",u=>{A.contains(u.target)||C.contains(u.target)||C.classList.add("!hidden")}),document.querySelectorAll("#currency-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".currency-select").textContent;L.textContent=e,F.classList.add("!hidden")})}),document.addEventListener("click",u=>{B.contains(u.target)||F.contains(u.target)||F.classList.add("!hidden")}),Array.from(document.getElementsByClassName("open-add-object")).forEach(u=>{u.addEventListener("click",()=>{document.getElementById("add-object-overlay").classList.remove("hidden")})})}}customElements.define("header-component",g);var x={};x=new URL("flag-eng.a2a964e4.svg",import.meta.url).toString();var f={};f=new URL("Facebook.dcf2fbbe.svg",import.meta.url).toString();var b={};b=new URL("Instagram.74df3eed.svg",import.meta.url).toString();var E={};E=new URL("Pinterest.66237f30.svg",import.meta.url).toString();var h={};h=new URL("Telegram.c0d61c3a.svg",import.meta.url).toString();var y={};y=new URL("Youtube.0f227ef9.svg",import.meta.url).toString();class w extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    <footer class="bg-white">
        ...
        <div class="main-footer side-paddings ">
            ...
            <div class="footer-icons">
                <a href="#">
                    <img src="${u(f)}" alt="Facebook">
                </a>
                <a href="#">
                    <img src="${u(b)}" alt="Instagram">
                </a>
                <a href="#">
    ...
    `;let s=document.getElementById("foo-leng"),a=document.getElementById("foo-leng-menu"),i=document.getElementById("foo-currency"),n=document.getElementById("foo-currency-menu"),c=document.getElementById("foo-currency-data");i.addEventListener("click",()=>{n.classList.toggle("!hidden")}),s.addEventListener("click",()=>{a.classList.toggle("!hidden")}),document.querySelectorAll("#foo-leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;s.innerHTML=e,a.classList.add("!hidden")})}),document.addEventListener("click",u=>{s.contains(u.target)||a.contains(u.target)||a.classList.add("!hidden")}),document.querySelectorAll("#foo-currency-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".currency-select").textContent;c.textContent=e,n.classList.add("!hidden")})}),document.addEventListener("click",u=>{i.contains(u.target)||n.contains(u.target)||n.classList.add("!hidden")})}}customElements.define("footer-component",w);var A={};A=new URL("arrow-down.d7848c8b.svg",import.meta.url).toString();var C={};C=new URL("sunset.822f0583.png",import.meta.url).toString(),document.addEventListener("DOMContentLoaded",function(){let u=document.querySelectorAll(".accordion");for(let e=0;e<u.length;e++)u[e].addEventListener("click",function(){this.classList.toggle("active");let u=this.nextElementSibling;"block"===u.style.display?(u.style.display="none",this.querySelector("img").style.transform="rotate(0deg)"):(u.style.display="block",this.querySelector("img").style.transform="rotate(180deg)")})});class B extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    ...
    `,document.querySelectorAll(".form-hotel").forEach(u=>{let e=u.querySelector("#booking-overlay"),t=e.querySelector("#close-popup"),l=u.querySelector("#check-in-date"),s=u.querySelector("#check-out-date");s.nextElementSibling;let a=u.querySelector("#guests"),i=u.querySelector("#guests-info"),n=u.querySelector("#close-info"),c=u.querySelector("#toggle-icon"),d=u.querySelector("#calendar"),r=d.querySelector("#prevMonth"),o=d.querySelector("#nextMonth"),m=d.querySelector("#calendar-error"),p=u.querySelector(".dates-error-message");l.addEventListener("click",()=>{l.value&&(l.value="",s.value="",document.querySelectorAll(".selected-date").forEach(u=>{u.classList.remove("selected-date")}),document.querySelectorAll(".date div").forEach(u=>{u.classList.remove("bg-orange-100")})),d.classList.remove("!hidden"),l.focus(),l.classList.add("active-outline"),s.classList.remove("active-outline")}),s.addEventListener("click",()=>{s.value&&(s.value="",l.value="",document.querySelectorAll(".selected-date").forEach(u=>{u.classList.remove("selected-date")}),document.querySelectorAll(".date div").forEach(u=>{u.classList.remove("bg-orange-100")})),d.classList.remove("!hidden"),l.focus(),l.classList.add("active-outline")}),document.addEventListener("click",u=>{d.contains(u.target)||l.contains(u.target)||s.contains(u.target)||d.classList.add("!hidden")}),a.addEventListener("click",()=>{i.classList.remove("hidden"),c.classList.toggle("-rotate-90")}),n.addEventListener("click",()=>{i.classList.add("hidden")}),u.addEventListener("submit",function(a){if(a.preventDefault(),!u.checkValidity())return;if(""===l.value||""===s){p.classList.remove("hidden");return}e.style.display="block";let i=setTimeout(()=>{u.submit(),console.log("submit")},3e4);t.addEventListener("click",()=>{e.style.display="none",clearTimeout(i),u.submit()})}),t.addEventListener("click",()=>{e.style.display="none"});let v=u.querySelector("#mphone");v.addEventListener("input",()=>{let u=v.value;/^[\d+()-]*$/.test(u)?v.setCustomValidity(""):v.setCustomValidity("Невірний формат номеру")}),u.querySelectorAll(".form-hotel input[required]").forEach(u=>{u.addEventListener("invalid",()=>{u.nextElementSibling.style.display="block"}),u!==s&&u.addEventListener("blur",()=>{u.nextElementSibling.style.display=u.checkValidity()?"none":"block"})}),function(u){let e=1,t=0,l=0,s=0;function a(u){u.querySelector("#adults").innerText=e,u.querySelector("#children").innerText=t,u.querySelector("#infants").innerText=l,u.querySelector("#pets").innerText=s;let a=e+t,i="";a>1?i+=`${a} \u{413}\u{43E}\u{441}\u{442}\u{435}\u{439}`:1===a&&(i+=`${a} \u{413}\u{456}\u{441}\u{442}\u{44C}`),l>1?i+=`, ${l} \u{41D}\u{435}\u{43C}\u{43E}\u{432}\u{43B}\u{44F}\u{442}`:1===l&&(i+=`, ${l} \u{41D}\u{435}\u{43C}\u{43E}\u{432}\u{43B}\u{44F}`),s>1?i+=`, ${s} \u{414}\u{43E}\u{43C}\u{430}\u{448}\u{43D}\u{456}\u{445} \u{443}\u{43B}\u{44E}\u{431}\u{43B}\u{435}\u{43D}\u{446}\u{456}\u{432}`:1===s&&(i+=`, ${s} \u{414}\u{43E}\u{43C}\u{430}\u{448}\u{43D}\u{456}\u{439} \u{443}\u{43B}\u{44E}\u{431}\u{43B}\u{435}\u{43D}\u{435}\u{446}\u{44C}`),u.querySelector("#total-guests").innerText=i}u.querySelector("#increase-adults").addEventListener("click",()=>{e<5&&(e++,a(u))}),u.querySelector("#decrease-adults").addEventListener("click",()=>{e>0&&(e--,a(u))}),u.querySelector("#increase-children").addEventListener("click",()=>{t<5&&(t++,a(u))}),u.querySelector("#decrease-children").addEventListener("click",()=>{t>0&&(t--,a(u))}),u.querySelector("#increase-infants").addEventListener("click",()=>{l<5&&(l++,a(u))}),u.querySelector("#decrease-infants").addEventListener("click",()=>{l>0&&(l--,a(u))}),u.querySelector("#increase-pets").addEventListener("click",()=>{s<5&&(s++,a(u))}),u.querySelector("#decrease-pets").addEventListener("click",()=>{s>0&&(s--,a(u))})}(u);let g=["Січень","Лютий","Березень","Квітень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень"],x=new Date().getMonth(),f=new Date().getFullYear(),b=0===x?11:x-1,E=0===x?f-1:f;function h(u,e,t){let a=g[e],i=new Date(t,e+1,0).getDate(),n=new Date(t,e,1).getDay();u.querySelector(".month-name").textContent=`${a} ${t}`;let c=u.querySelector(".date");c.innerHTML="";for(let u=0;u<n;u++){let u=document.createElement("div");u.textContent="",c.appendChild(u)}for(let u=1;u<=i;u++){let a=document.createElement("div");a.textContent=u,c.appendChild(a),a.addEventListener("click",i=>{let n=new Date(t,e,u),c=n.getFullYear().toString(),r=(n.getMonth()+1).toString().padStart(2,"0"),o=n.getDate().toString().padStart(2,"0"),p=`${o}.${r}.${c}`;l.value?s.value||(new Date(t,e,u)>new Date(l.value.split(".").reverse().join("-"))?(s.value=p,a.classList.add("selected-date"),m.classList.add("hidden"),d.classList.add("!hidden"),s.classList.remove("active-outline")):m.classList.remove("hidden")):(l.value=p,a.classList.add("selected-date"),s.focus(),l.classList.remove("active-outline"),s.classList.add("active-outline"))})}}h(r,b,E),h(o,x,f),document.querySelectorAll(".calendar .date").forEach(u=>{u.addEventListener("mouseover",u=>{let e=document.querySelector("#check-in-date").value,t=u.target;(function(u,e){let t=new Date(u.split(".").reverse().join("-"));document.querySelectorAll(".calendar .date").forEach(u=>{u.childNodes.forEach(l=>{let s=new Date(parseInt(u.closest(".month").querySelector(".month-name").textContent.split(" ")[1]),g.indexOf(u.closest(".month").querySelector(".month-name").textContent.split(" ")[0]),parseInt(l.textContent));t<=s&&s<=e?l.classList.add("bg-orange-100"):l.classList.remove("bg-orange-100")})})})(e,new Date(parseInt(t.closest(".month").querySelector(".month-name").textContent.split(" ")[1]),g.indexOf(t.closest(".month").querySelector(".month-name").textContent.split(" ")[0]),parseInt(t.textContent)))})});let y=u.querySelector(".prevMonthBtn"),w=u.querySelectorAll(".nextMonthBtn");y.addEventListener("click",()=>{x!==new Date().getMonth()&&--x<0&&(x=11,f--),y.disabled=x===new Date().getMonth(),h(r,b=0===x?11:x-1,E=0===x?f-1:f),h(o,x,f)}),w.forEach(u=>{u.addEventListener("click",()=>{++x>11&&(x=0,f++),h(r,b=0===x?11:x-1,E=0===x?f-1:f),h(o,x,f),y.disabled=!1})})})}}customElements.define("booking-form",k);class q extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
            ...
            <form class="search-area" id="search-form">
                    ...
                    <input type="reset" value="&#x2715;" class="reset-btn hidden"/>
                     <button id="search_btn" class="pr-1 lg:pr-2" type="submit">
                         <img src="${u(o)}" alt="icon" class="max-w-fit round-icon">
                     </button>
            </form>
        ...
        `,document.addEventListener("DOMContentLoaded",function(){let u=document.getElementById("search-form"),e=document.getElementById("search-input"),t=document.getElementById("search-results"),l=document.querySelector(".reset-btn");e.addEventListener("input",()=>{l.classList.toggle("hidden",0===e.value.length)}),l.addEventListener("click",()=>{e.value="",e.dispatchEvent(new Event("input")),t.classList.add("hidden")}),u.addEventListener("submit",function(u){u.preventDefault();let l=e.value.trim();if(console.log(l),0===l.length){alert("Введіть будь-ласка запит для пошуку.");return}t.classList.remove("hidden")}),document.body.addEventListener("click",function(e){let l=u.contains(e.target),s=t.contains(e.target);l||s||t.classList.add("hidden")})}),Array.from(document.getElementsByClassName("hotel-card-res")).forEach(u=>{u.addEventListener("click",()=>{window.location.href="hotel.html"})})}}customElements.define("search-area",X);
//# sourceMappingURL=become-a-guide.eff95219.js.map
