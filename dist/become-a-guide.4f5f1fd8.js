function u(u){return u&&u.__esModule?u.default:u}var e={};e=new URL("flag-ua.206ac488.svg",import.meta.url).toString();var t={};t=new URL("flag-ru.88f26cb7.svg",import.meta.url).toString();var l={};l=new URL("flag-germany.831dd278.svg",import.meta.url).toString();var s={};s=new URL("telegram.24c4005e.svg",import.meta.url).toString();var a={};a=new URL("viber.f82a6078.svg",import.meta.url).toString();var i={};i=new URL("menu_burger.81edf69f.svg",import.meta.url).toString();var n={};n=new URL("logo.8de3bcdb.png",import.meta.url).toString();var c={};c=new URL("add_object_icon.82b1f3ce.svg",import.meta.url).toString();var d={};d=new URL("become_a_guide_icon.69829ad1.svg",import.meta.url).toString();var r={};r=new URL("phone-header-icon.cf788f78.svg",import.meta.url).toString();var o={};o=new URL("search_icon.aeb707ee.svg",import.meta.url).toString(),new URL("donate_button.7f042bee.svg",import.meta.url).toString();var m={};m=new URL("phone-orange.e3912029.svg",import.meta.url).toString();var p={};p=new URL("telegram-orange.6f2c5380.svg",import.meta.url).toString();var v={};v=new URL("viber-orange.efa35444.svg",import.meta.url).toString();class g extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    ...
    <footer class="bg-white">
        ...
        <div class="main-footer side-paddings ">
            ...
            <div class="footer-icons">
                <a href="#">
                    <img src="${u(x)}" alt="Facebook">
                </a>
                <a href="#">
                    <img src="${u(f)}" alt="Instagram">
                </a>
                <a href="#">
                    <img src="${u(b)}" alt="Pinterest">
                </a>
                <a href="#">
                    <img src="${u(E)}" alt="Telegram">
                </a>
                <a href="#">
                    <img src="${u(h)}" alt="Youtube">
                </a> 
            </div>
        </div>
        ...
        <div class="copyright side-paddings">
            <div class="flex sm:mb-4 md:mb-4 lg:mb-0">
                <button type="button" class="leng mr-5" id="foo-leng">
                    <div class="uppercase text-base mr-1 text-text-secondary">ua</div>
                    <img src="${u(e)}" alt="flag">
                </button>
    ...
    `;let s=document.getElementById("foo-leng"),a=document.getElementById("foo-leng-menu"),i=document.getElementById("foo-currency"),n=document.getElementById("foo-currency-menu"),c=document.getElementById("foo-currency-data");i.addEventListener("click",()=>{n.classList.toggle("!hidden")}),s.addEventListener("click",()=>{a.classList.toggle("!hidden")}),document.querySelectorAll("#foo-leng-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".leng").innerHTML;s.innerHTML=e,a.classList.add("!hidden")})}),document.addEventListener("click",u=>{s.contains(u.target)||a.contains(u.target)||a.classList.add("!hidden")}),document.querySelectorAll("#foo-currency-menu li").forEach(u=>{u.addEventListener("click",()=>{let e=u.querySelector(".currency-select").textContent;c.textContent=e,n.classList.add("!hidden")})}),document.addEventListener("click",u=>{i.contains(u.target)||n.contains(u.target)||n.classList.add("!hidden")})}}customElements.define("footer-component",y);var w={};w=new URL("arrow-down.d7848c8b.svg",import.meta.url).toString();var A={};A=new URL("sunset.822f0583.png",import.meta.url).toString(),document.addEventListener("DOMContentLoaded",function(){let u=document.querySelectorAll(".accordion");for(let e=0;e<u.length;e++)u[e].addEventListener("click",function(){this.classList.toggle("active");let u=this.nextElementSibling;"block"===u.style.display?(u.style.display="none",this.querySelector("img").style.transform="rotate(0deg)"):(u.style.display="block",this.querySelector("img").style.transform="rotate(180deg)")})});class C extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
        <h2 class="main-title">\u{41F}\u{43E}\u{448}\u{438}\u{440}\u{435}\u{43D}\u{456} \u{437}\u{430}\u{43F}\u{438}\u{442}\u{430}\u{43D}\u{43D}\u{44F}</h2>
            <div class="faq">
                ...
                <img src="${u(A)}" alt="img" class="faq-img">
            </div>
    `}}customElements.define("faq-component",C);var B={};B=new URL("x.b6b5ca8f.svg",import.meta.url).toString();var F={};F=new URL("tabler-icon-circle-check.24895de6.jpg",import.meta.url).toString();var L={};L=new URL("ava.060342ab.jpg",import.meta.url).toString();var D={};D=new URL("icon-phone.bd17d90e.svg",import.meta.url).toString();class S extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
        <div class="sidebar">
            ...
            <div id="search-results" class="hidden">
                <ul>
                    <li class="search-result-item">
                        <img src="${u(q)}" alt="picture" class="result-photo">
                        <div class="flex flex-col gap-1">
                    ...
                    <li class="search-result-item hotel-card-res">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-row justify-start">
                                <img src="${u(j)}" alt="icon" class="w-[20px] h-[20px]">
                            ...
                            <div class="hotel-phone">
                                ...
                                <img src="${u(I)}" alt="icon" class="eye-icon">
                            </div>
                            <div class="flex flex-row justify-start">
                                <img src="${u(M)}" alt="icon">
