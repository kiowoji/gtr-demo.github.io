...
})({"e5GRc":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f235bbba41c617a2";
"use strict";
...
},{}],"2qOuW":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function() {
    ...
    function showSlides(n) {
        ...
        for(i = 0; i < dots.length; i++)dots[i].className = dots[i].className.replace(" dots-active", "");
    ...
    sliderOverlay.addEventListener("click", (e)=>{
        if (!photosPopup.contains(e.target)) sliderOverlay.classList.add("hidden");
    });
    ...
    reviewsOverlay.addEventListener("click", (e)=>{
        if (!e.target.contains.reviewsPopup) reviewsOverlay.classList.add("hidden");
    });
    ...
    openServicesBtn.addEventListener("click", ()=>{
        ...
        if (!servicesHidden.classList.contains("hidden")) openServicesBtn.innerHTML = `\u{41F}\u{43E}\u{43A}\u{430}\u{437}\u{430}\u{442}\u{438} \u{43C}\u{435}\u{43D}\u{448}\u{435} <span><</span>`;
        else openServicesBtn.innerHTML = `\u{41F}\u{43E}\u{43A}\u{430}\u{437}\u{430}\u{442}\u{438} \u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} <span>></span>`;
    });
    ...
    openServicesMapBtn.addEventListener("click", ()=>{
        ...
        if (!servicesMapHidden.classList.contains("hidden")) openServicesMapBtn.innerHTML = `\u{417}\u{433}\u{43E}\u{440}\u{43D}\u{443}\u{442}\u{438} <span><</span>`;
        else openServicesMapBtn.innerHTML = `\u{41F}\u{43E}\u{43A}\u{430}\u{437}\u{430}\u{442}\u{438} \u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} <span>></span>`;
    });
    ...
    checkboxes.forEach(function(checkbox) {
        checkbox.addEventListener("change", function() {
            if (this.checked) this.parentElement.classList.add("active-wrapper");
            else this.parentElement.classList.remove("active-wrapper");
        });
    });
});

},{}]},["e5GRc","2qOuW"], "2qOuW", "parcelRequireccbb")

//# sourceMappingURL=hotel.41c617a2.js.map
