...
var _searchAreaJs = require("./components/search-area.js");
var _authForm = require("./components/auth-form"); // const select_btn = document.getElementById('select_open')
...
},{"./components/header.js":"aorvA","./components/footer.js":"bjsug","./components/faq.js":"lGrr8","./components/booking-form.js":"cumXt","./components/add-object-form.js":"aLN1w","./components/search-area.js":"2sZAG","./components/auth-form":"5JfdG"}],"aorvA":[function(require,module,exports) {
...
},{"5dd29987dabf64d3":"lgJ39"}],"5JfdG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _telegram2Svg = require("/src/public/images/telegram2.svg");
var _telegram2SvgDefault = parcelHelpers.interopDefault(_telegram2Svg);
var _facebookSvg = require("/src/public/images/facebook.svg");
var _facebookSvgDefault = parcelHelpers.interopDefault(_facebookSvg);
var _googleSvg = require("/src/public/images/google.svg");
var _googleSvgDefault = parcelHelpers.interopDefault(_googleSvg);
var _emailSvg = require("/src/public/images/email.svg");
                ...
                <div id="main-window" class="">
                    ...
                    <div class="relative">
                        ...
                        <a href="https://t.me/infoGoToRest" class="flex flex-row auth-fields border-2 border-black items-center justify-center gap-5 mt-8 cursor-pointer hover:bg-zinc-100">
                            <img src=${0, _telegram2SvgDefault.default} alt="telegram" class="auth-icons">
                        ...
                        <a href="#" class="flex flex-row auth-fields border-2 border-black items-center justify-center gap-5 mt-5 cursor-pointer hover:bg-zinc-100">
                            <img src=${0, _facebookSvgDefault.default} alt="facebook" class="auth-icons">
                        ...
                        <a href="#" class="flex flex-row auth-fields border-2 border-black items-center justify-center gap-5 mt-5 cursor-pointer hover:bg-zinc-100">
                            <img src=${0, _googleSvgDefault.default} alt="google" class="auth-icons">
                        ...
                        <a href="#" class="flex flex-row auth-fields border-2 border-black items-center justify-center gap-5 mt-5 cursor-pointer hover:bg-zinc-100 mb-5" id="continue-by-email">
                            <img src=${0, _emailSvgDefault.default} alt="email" class="auth-icons">
    ...
    `;
        document.addEventListener("DOMContentLoaded", function() {
            ...
            authPhoneForm.addEventListener("submit", function(event) {
                event.preventDefault();
                if (!authPhoneForm.checkValidity() || !phoneFormSubmissionAllowed) return;
                else {
            ...
            emailInput.addEventListener("input", ()=>{
                if (emailInput.checkValidity()) emailErrorMessage.style.display = "none";
                else emailErrorMessage.style.display = "block";
            });
            ...
            authEmailForm.addEventListener("submit", function(event) {
                event.preventDefault();
                if (!authEmailForm.checkValidity()) return;
                else {
                    // authPhoneForm.submit();
            ...
            requiredInputs.forEach((input)=>{
                ...
                input.addEventListener("input", ()=>{
                    if (input.checkValidity()) input.nextElementSibling.style.display = "none";
                });
            });
            ...
            signinPhoneInput.addEventListener("input", function(event) {
                ...
                if (!inputValue && !inputValue.value) signinPhoneInput.nextElementSibling.style.display = "none";
                else if (!/^[0-9+\-()]{8,15}$/.test(inputValue)) signinPhoneInput.nextElementSibling.style.display = "block";
                else signinPhoneInput.nextElementSibling.style.display = "none";
            });
            signinPassword.addEventListener("input", ()=>{
                ...
                } else signinPassword.nextElementSibling.style.display = "none";
            });
            signInForm.addEventListener("submit", (event)=>{
                event.preventDefault();
                if (signinPassword.value.length <= 7) return;
                else if (!formSubmissionAllowed) return;
                else signInForm.submit();
            });
            passwordCheckbox.addEventListener("click", ()=>{
                if (signinPassword.type === "password") signinPassword.type = "text";
                else signinPassword.type = "password";
            });
            // login
            ...
            loginPassword.addEventListener("input", ()=>{
                ...
                } else loginPassword.nextElementSibling.style.display = "none";
            });
...
},{"/src/public/images/telegram2.svg":"kmIfn","/src/public/images/facebook.svg":"2Ujy9","/src/public/images/google.svg":"3axFR","/src/public/images/email.svg":"gFSVA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kmIfn":[function(require,module,exports) {
module.exports = require("9d172477cdd77f47").getBundleURL("lPpKD") + "telegram2.52bcc5ed.svg" + "?" + Date.now();

},{"9d172477cdd77f47":"lgJ39"}],"2Ujy9":[function(require,module,exports) {
module.exports = require("4f97789df2025338").getBundleURL("lPpKD") + "facebook.c17a146d.svg" + "?" + Date.now();

},{"4f97789df2025338":"lgJ39"}],"3axFR":[function(require,module,exports) {
module.exports = require("1a848798c52feb19").getBundleURL("lPpKD") + "google.42056ac7.svg" + "?" + Date.now();

},{"1a848798c52feb19":"lgJ39"}],"gFSVA":[function(require,module,exports) {
module.exports = require("7ca499e8e7ecc5d8").getBundleURL("lPpKD") + "email.2be5eb86.svg" + "?" + Date.now();
