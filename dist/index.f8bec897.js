...
})({"35CI6":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "33b88fabf8bec897";
"use strict";
...
},{}],"35eLC":[function(require,module,exports) {
...
var _heartSvg = require("/src/public/images/hotel/heart.svg");
var _heartSvgDefault = parcelHelpers.interopDefault(_heartSvg);
var _376862503Webp = require("/src/public/images/hotel/376862503.webp");
var _376862503WebpDefault = parcelHelpers.interopDefault(_376862503Webp);
// mock data
const hotels = [
    {
        id: 1,
        image: `${(0, _376862503WebpDefault.default)}`,
        name: "\u0415\u043A\u043E-\u0441\u0430\u0434\u0438\u0431\u0430 \xab\u0412\u0430\u0441\u043A\u0443\u043B\xbb",
        url: "./hotel.html",
    ...
    },
    {
        id: 2,
        image: `${(0, _376862503WebpDefault.default)}`,
        name: "\u0413\u043E\u0441\u0442\u0438\u043D\u043D\u0438\u0439 \u0434\u0432\u0456\u0440 \xab\u041B\u0456\u0441\u043E\u0432\u0430 \u043A\u0430\u0437\u043A\u0430 \u0432 \u043B\u0456\u0441\u0456\xbb",
        url: "./hotel.html",
        address: "\u0441. \u041B\u0443\u043C\u0448\u043E\u0440\u0438, \u0432\u0443\u043B. \u041B\u0443\u0433\u043E\u0432\u0430, 5, \u0417\u0430\u043A\u0430\u0440\u043F\u0430\u0442\u0441\u044C\u043A\u0430 \u043E\u0431\u043B\u0430\u0441\u0442\u044C, \u0423\u043A\u0440\u0430\u0457\u043D\u0430",
        phone: "+380969036281",
        price: "\u0432\u0456\u0434 1070 \u20B4 / \u043D\u0456\u0447",
...
async function displayHotels(service = "") {
    try {
        ...
        hotels.forEach((hotel)=>{
            ...
            hotelCard.innerHTML = `
        <img src=${0, _heartSvgDefault.default} alt="like" class="like-icon">
...
},{}],"4fdrj":[function(require,module,exports) {
module.exports = require("efdb2d57d20c7923").getBundleURL("4rjbb") + "icon-coins.6e02d58b.svg" + "?" + Date.now();

},{"efdb2d57d20c7923":"lgJ39"}],"7dsEt":[function(require,module,exports) {
module.exports = require("f0cfa33ceec69bac").getBundleURL("4rjbb") + "icon-phone.fbb91204.svg" + "?" + Date.now();

},{"f0cfa33ceec69bac":"lgJ39"}],"d1q9L":[function(require,module,exports) {
module.exports = require("19c7f897bf814a14").getBundleURL("4rjbb") + "icon-map.e4ed9d9f.svg" + "?" + Date.now();

},{"19c7f897bf814a14":"lgJ39"}],"cjZ7w":[function(require,module,exports) {
module.exports = require("508b0c30e61860cf").getBundleURL("4rjbb") + "heart.4d90c23a.svg" + "?" + Date.now();

},{"508b0c30e61860cf":"lgJ39"}],"4UewU":[function(require,module,exports) {
module.exports = require("27f9e4297bfc46ae").getBundleURL("4rjbb") + "376862503.029697fb.webp" + "?" + Date.now();

},{"27f9e4297bfc46ae":"lgJ39"}]},["35CI6","35eLC"], "35eLC", "parcelRequireccbb")

//# sourceMappingURL=index.f8bec897.js.map
